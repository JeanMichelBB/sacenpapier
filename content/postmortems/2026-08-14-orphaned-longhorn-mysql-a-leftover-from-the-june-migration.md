...
A storage or infrastructure migration isn't finished when the new thing works — it's finished when the old thing is gone. [The June 2nd postmortem](/postmortems/2026-06-02-mysql-k3s-recovery) should have included a step to decommission the pre-migration instance, not just stand up the replacement. Going forward, any migration postmortem gets an explicit "old resource removed" checkmark before being called closed, not just "new resource healthy."
