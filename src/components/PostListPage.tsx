...
export function PostListPage({ titleKey, basePath, posts, currentPage }: Props) {
  ...
  const paged = posts.slice((safePage - 1) * PER_PAGE, safePage * PER_PAGE);
      ...
      <div className="mx-auto max-w-3xl px-6 py-16">
        ...
        {pageCount > 1 && (
          <nav className="mt-10 flex items-center justify-center gap-4 text-sm">
            {safePage > 1 ? (
              <Link
                href={safePage - 1 === 1 ? basePath : `${basePath}?page=${safePage - 1}`}
